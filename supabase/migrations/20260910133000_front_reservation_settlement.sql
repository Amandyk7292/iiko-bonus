-- Keep confirmed allocations when the remaining walk-in stock sells before
-- payment settlement. Expired/released holds must still reacquire with the buffer.
