...
The first supported baseline is 1.0.7+42. Build 1.0.6+40 was built with stock Flutter and cannot receive Shorebird patches.
...
Apple rejected the 1.0.6+41 upload because version 1.0.6 was already approved and its release train closed. The Shorebird release exists, but that IPA was not accepted into App Store Connect. The first installable OTA baseline is 1.0.7+42.
