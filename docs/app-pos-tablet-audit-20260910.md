...
Обновление после аудита: реализованы серверный общий учёт, привязка чека,
блокировки повторной лояльности, сверка и входящие заказы в плагине 1.4.0.
[Описание нового режима и обязательная проверка на кассах](iiko-front-shared-stock.md).
Владелец сообщил, что плагин ещё не установлен. Ниже сохранены результаты
исходного аудита до этих изменений; они не означают, что новая защита включена.
