...
router.get('/admin/api/iiko-operations', adminAuthMiddleware, adminController.getIikoOperationsHandler);
...
router.post('/admin/api/customers/update', adminAuthMiddleware, adminController.updateCustomerHandler);
router.post('/admin/api/customers/expire-inactive', adminAuthMiddleware, adminController.expireInactiveHandler);
router.post('/admin/api/customers/notify-inactive', adminAuthMiddleware, adminController.notifyInactiveHandler);
router.delete('/admin/api/customers/:id', adminAuthMiddleware, adminController.deleteCustomerHandler);
