...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1352: (x0,x1,x2) => x0.postMessage(x1,x2),
      ...
      _1364: (x0,x1,x2) => ({enableHighAccuracy: x0,timeout: x1,maximumAge: x2}),
      _1365: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
      _1370: (x0,x1) => x0.getItem(x1),
      _1371: (x0,x1) => x0.removeItem(x1),
      _1372: (x0,x1,x2) => x0.setItem(x1,x2),
      _1376: x0 => globalThis.firebase_core.getApp(x0),
      _1377: () => globalThis.firebase_core.getApp(),
      _1378: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      _1380: x0 => globalThis.firebase_messaging.getMessaging(x0),
      _1382: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      _1384: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      _1385: (x0,x1) => ({next: x0,error: x1}),
      _1391: x0 => x0.title,
      _1392: x0 => x0.body,
      _1393: x0 => x0.image,
      _1394: x0 => x0.messageId,
      _1395: x0 => x0.collapseKey,
      _1396: x0 => x0.fcmOptions,
      _1397: x0 => x0.notification,
      _1398: x0 => x0.data,
      _1399: x0 => x0.from,
      _1400: x0 => x0.analyticsLabel,
      _1401: x0 => x0.link,
      ...
      _1406: () => globalThis.firebase_core.SDK_VERSION,
      _1412: x0 => x0.apiKey,
      _1414: x0 => x0.authDomain,
      _1416: x0 => x0.databaseURL,
      _1418: x0 => x0.projectId,
      _1420: x0 => x0.storageBucket,
      _1422: x0 => x0.messagingSenderId,
      _1424: x0 => x0.measurementId,
      _1426: x0 => x0.appId,
      _1428: x0 => x0.recaptchaSiteKey,
      _1430: x0 => x0.name,
      _1431: x0 => x0.options,
      _1432: (x0,x1) => x0.debug(x1),
      ...
      _1435: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1436: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1437: (x0,x1) => x0.createScriptURL(x1),
      _1438: (x0,x1,x2) => x0.createScript(x1,x2),
      _1439: (x0,x1) => x0.appendChild(x1),
      _1440: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1440(f,arguments.length,x0) }),
      _1441: () => globalThis.removeSplashFromWeb(),
      _1443: Date.now,
      _1445: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1446: s => {
      ...
      _1481: Object.is,
      _1482: o => o instanceof Array,
      _1483: (a, i) => a.push(i),
      _1487: a => a.pop(),
      _1488: (a, i) => a.splice(i, 1),
      _1489: (a, s) => a.join(s),
      _1490: (a, s, e) => a.slice(s, e),
      _1492: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1493: a => a.length,
      _1495: (a, i) => a[i],
      _1496: (a, i, v) => a[i] = v,
      _1498: o => {
      ...
      _1499: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1501: o => o instanceof Uint8Array,
      _1502: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1503: o => o instanceof Int8Array,
      _1504: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1505: o => o instanceof Uint8ClampedArray,
      _1506: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1507: o => o instanceof Uint16Array,
      _1508: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1509: o => o instanceof Int16Array,
      _1510: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1511: o => o instanceof Uint32Array,
      _1512: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1513: o => o instanceof Int32Array,
      _1514: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1516: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1517: o => o instanceof Float32Array,
      _1518: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1519: o => o instanceof Float64Array,
      _1520: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1521: (t, s) => t.set(s),
      _1522: l => new DataView(new ArrayBuffer(l)),
      _1523: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1525: o => o.buffer,
      _1526: o => o.byteOffset,
      _1527: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1528: (b, o) => new DataView(b, o),
      _1529: (b, o, l) => new DataView(b, o, l),
      _1530: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1531: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1532: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1533: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1534: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1535: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1536: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1537: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1538: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1539: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1540: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1541: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1544: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1545: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1546: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1547: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1548: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1549: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1562: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1563: (handle) => clearTimeout(handle),
      _1564: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1565: (handle) => clearInterval(handle),
      _1566: (c) =>
      ...
      _1569: (x0,x1) => x0.exec(x1),
      _1570: (x0,x1) => x0.test(x1),
      _1571: x0 => x0.pop(),
      _1573: o => o === undefined,
      _1575: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1577: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1578: o => o instanceof RegExp,
      _1579: (l, r) => l === r,
      _1580: o => o,
      _1581: o => o,
      _1582: o => o,
      ...
      _1584: o => o.length,
      _1586: (o, i) => o[i],
      _1587: f => f.dartFunction,
      _1588: () => ({}),
      _1589: () => [],
      _1591: () => globalThis,
      _1592: (constructor, args) => {
      ...
      _1594: (o, p) => o[p],
      _1595: (o, p, v) => o[p] = v,
      _1596: (o, m, a) => o[m].apply(o, a),
      _1598: o => String(o),
      _1599: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      ...
      _1603: o => [o],
      _1604: (o0, o1) => [o0, o1],
      _1605: (o0, o1, o2) => [o0, o1, o2],
      _1606: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1620: x0 => x0.index,
      _1622: x0 => x0.flags,
      _1623: x0 => x0.multiline,
      _1624: x0 => x0.ignoreCase,
      _1625: x0 => x0.unicode,
      _1626: x0 => x0.dotAll,
      _1627: (x0,x1) => { x0.lastIndex = x1 },
      _1628: (o, p) => p in o,
      _1629: (o, p) => o[p],
      _1630: (o, p, v) => o[p] = v,
      _1631: (o, p) => delete o[p],
      _1646: () => new AbortController(),
      _1647: x0 => x0.abort(),
      _1648: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1649: (x0,x1) => globalThis.fetch(x0,x1),
      _1650: (x0,x1) => x0.get(x1),
      _1651: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1651(f,arguments.length,x0,x1,x2) }),
      _1652: (x0,x1) => x0.forEach(x1),
      _1653: x0 => x0.getReader(),
      _1654: x0 => x0.cancel(),
      _1655: x0 => x0.read(),
      _1656: (x0,x1) => x0.key(x1),
      _1657: x0 => x0.trustedTypes,
      _1658: (x0,x1) => { x0.text = x1 },
      _1659: x0 => x0.random(),
      _1660: (x0,x1) => x0.getRandomValues(x1),
      _1661: () => globalThis.crypto,
      _1662: () => globalThis.Math,
      ...
      _1679: () => globalThis.document,
      _1685: (x0,x1) => { x0.height = x1 },
      _1687: (x0,x1) => { x0.width = x1 },
      _1696: x0 => x0.style,
      _1699: x0 => x0.src,
      _1700: (x0,x1) => { x0.src = x1 },
      _1701: x0 => x0.naturalWidth,
      _1702: x0 => x0.naturalHeight,
      _1718: x0 => x0.status,
      _1719: (x0,x1) => { x0.responseType = x1 },
      _1721: x0 => x0.response,
      _1817: (x0,x1) => { x0.title = x1 },
      _1848: x0 => x0.style,
      _2325: (x0,x1) => { x0.src = x1 },
      _2344: x0 => x0.contentWindow,
      _3087: (x0,x1) => { x0.type = x1 },
      _3095: (x0,x1) => { x0.crossOrigin = x1 },
      _3097: (x0,x1) => { x0.text = x1 },
      _3554: () => globalThis.window,
      _3597: x0 => x0.location,
      _3616: x0 => x0.navigator,
      _3878: x0 => x0.trustedTypes,
      ...
      _9091: x0 => x0.state,
      _10408: x0 => x0.coords,
      _10409: x0 => x0.timestamp,
      _10411: x0 => x0.accuracy,
      _10412: x0 => x0.latitude,
      _10413: x0 => x0.longitude,
      _10414: x0 => x0.altitude,
      _10415: x0 => x0.altitudeAccuracy,
      _10416: x0 => x0.heading,
      _10417: x0 => x0.speed,
      _10418: x0 => x0.code,
      _10419: x0 => x0.message,
      _10827: (x0,x1) => { x0.border = x1 },
      _11105: (x0,x1) => { x0.display = x1 },
      _11269: (x0,x1) => { x0.height = x1 },
      _11959: (x0,x1) => { x0.width = x1 },
      _12327: x0 => x0.name,
      _13045: () => globalThis.console,
      _13073: x0 => x0.name,
      _13074: x0 => x0.message,
      _13075: x0 => x0.code,
