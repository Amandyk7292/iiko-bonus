...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1360: (x0,x1,x2) => ({enableHighAccuracy: x0,timeout: x1,maximumAge: x2}),
      _1361: (x0,x1,x2,x3) => x0.getCurrentPosition(x1,x2,x3),
      _1366: (x0,x1) => x0.getItem(x1),
      _1367: (x0,x1) => x0.removeItem(x1),
      _1368: (x0,x1,x2) => x0.setItem(x1,x2),
      _1372: x0 => globalThis.firebase_core.getApp(x0),
      _1373: () => globalThis.firebase_core.getApp(),
      _1374: (x0,x1,x2) => globalThis.firebase_core.registerVersion(x0,x1,x2),
      _1376: x0 => globalThis.firebase_messaging.getMessaging(x0),
      _1378: (x0,x1) => globalThis.firebase_messaging.getToken(x0,x1),
      _1380: (x0,x1) => globalThis.firebase_messaging.onMessage(x0,x1),
      _1381: (x0,x1) => ({next: x0,error: x1}),
      _1387: x0 => x0.title,
      _1388: x0 => x0.body,
      _1389: x0 => x0.image,
      _1390: x0 => x0.messageId,
      _1391: x0 => x0.collapseKey,
      _1392: x0 => x0.fcmOptions,
      _1393: x0 => x0.notification,
      _1394: x0 => x0.data,
      _1395: x0 => x0.from,
      _1396: x0 => x0.analyticsLabel,
      _1397: x0 => x0.link,
      ...
      _1402: () => globalThis.firebase_core.SDK_VERSION,
      _1408: x0 => x0.apiKey,
      ...
      _1422: x0 => x0.appId,
      _1424: x0 => x0.recaptchaSiteKey,
      _1426: x0 => x0.name,
      _1427: x0 => x0.options,
      _1428: (x0,x1) => x0.debug(x1),
      _1429: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1429(f,arguments.length,x0) }),
      _1430: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1430(f,arguments.length,x0,x1) }),
      _1431: (x0,x1) => ({createScript: x0,createScriptURL: x1}),
      _1432: (x0,x1,x2) => x0.createPolicy(x1,x2),
      _1433: (x0,x1) => x0.createScriptURL(x1),
      _1434: (x0,x1,x2) => x0.createScript(x1,x2),
      _1435: (x0,x1) => x0.appendChild(x1),
      ...
      _1444: () => typeof dartUseDateNowForTicks !== "undefined",
      _1445: () => 1000 * performance.now(),
      _1446: () => Date.now(),
      _1447: () => {
      ...
      _1449: () => new WeakMap(),
      _1450: (map, o) => map.get(o),
      _1451: (map, o, v) => map.set(o, v),
      _1452: x0 => new WeakRef(x0),
      _1453: x0 => x0.deref(),
      _1460: () => globalThis.WeakRef,
      _1464: s => JSON.stringify(s),
      _1465: s => printToConsole(s),
      _1466: (o, p, r) => o.replaceAll(p, () => r),
      _1467: (o, p, r) => o.replace(p, () => r),
      ...
      _1477: Object.is,
      _1478: o => o instanceof Array,
      _1479: (a, i) => a.push(i),
      _1483: a => a.pop(),
      _1484: (a, i) => a.splice(i, 1),
      _1485: (a, s) => a.join(s),
      _1486: (a, s, e) => a.slice(s, e),
      _1488: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1489: a => a.length,
      _1491: (a, i) => a[i],
      _1492: (a, i, v) => a[i] = v,
      _1494: o => {
      ...
      _1495: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1497: o => o instanceof Uint8Array,
      _1498: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1499: o => o instanceof Int8Array,
      _1500: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1501: o => o instanceof Uint8ClampedArray,
      _1502: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1503: o => o instanceof Uint16Array,
      _1504: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1505: o => o instanceof Int16Array,
      _1506: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1507: o => o instanceof Uint32Array,
      _1508: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1509: o => o instanceof Int32Array,
      _1510: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1512: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1513: o => o instanceof Float32Array,
      _1514: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1515: o => o instanceof Float64Array,
      _1516: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1517: (t, s) => t.set(s),
      _1518: l => new DataView(new ArrayBuffer(l)),
      _1519: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1521: o => o.buffer,
      _1522: o => o.byteOffset,
      _1523: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1524: (b, o) => new DataView(b, o),
      _1525: (b, o, l) => new DataView(b, o, l),
      _1526: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1527: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1528: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1529: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1530: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1531: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1532: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1533: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1534: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1535: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1536: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1537: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1540: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1541: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1542: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1543: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1544: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1545: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1558: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1559: (handle) => clearTimeout(handle),
      _1560: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1561: (handle) => clearInterval(handle),
      _1562: (c) =>
      ...
      _1580: o => o.length,
      _1582: (o, i) => o[i],
      _1583: f => f.dartFunction,
      _1584: () => ({}),
      _1585: () => [],
      _1587: () => globalThis,
      _1588: (constructor, args) => {
      ...
      _1590: (o, p) => o[p],
      _1591: (o, p, v) => o[p] = v,
      _1592: (o, m, a) => o[m].apply(o, a),
      _1594: o => String(o),
      _1595: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      ...
      _1599: o => [o],
      _1600: (o0, o1) => [o0, o1],
      _1601: (o0, o1, o2) => [o0, o1, o2],
      _1602: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1616: x0 => x0.index,
      _1618: x0 => x0.flags,
      _1619: x0 => x0.multiline,
      _1620: x0 => x0.ignoreCase,
      _1621: x0 => x0.unicode,
      _1622: x0 => x0.dotAll,
      _1623: (x0,x1) => { x0.lastIndex = x1 },
      _1624: (o, p) => p in o,
      _1625: (o, p) => o[p],
      _1626: (o, p, v) => o[p] = v,
      _1627: (o, p) => delete o[p],
      ...
      _1653: x0 => x0.trustedTypes,
      _1654: (x0,x1) => { x0.text = x1 },
      _1655: x0 => x0.random(),
      ...
      _1669: Function.prototype.call.bind(BigInt.prototype.toString),
      _1670: Function.prototype.call.bind(Number.prototype.toString),
      _1671: (d, digits) => d.toFixed(digits),
      _1675: () => globalThis.document,
      _1681: (x0,x1) => { x0.height = x1 },
      _1683: (x0,x1) => { x0.width = x1 },
      _1692: x0 => x0.style,
      _1695: x0 => x0.src,
      _1696: (x0,x1) => { x0.src = x1 },
      _1697: x0 => x0.naturalWidth,
      _1698: x0 => x0.naturalHeight,
      _1714: x0 => x0.status,
      _1715: (x0,x1) => { x0.responseType = x1 },
      _1717: x0 => x0.response,
      _3083: (x0,x1) => { x0.type = x1 },
      _3091: (x0,x1) => { x0.crossOrigin = x1 },
      _3093: (x0,x1) => { x0.text = x1 },
      _3550: () => globalThis.window,
      _3612: x0 => x0.navigator,
      _3874: x0 => x0.trustedTypes,
      _3875: x0 => x0.sessionStorage,
      _3876: x0 => x0.localStorage,
      _3982: x0 => x0.geolocation,
      _3987: x0 => x0.permissions,
      _4001: x0 => x0.userAgent,
      _4209: x0 => x0.length,
      _6154: x0 => x0.signal,
      _6228: () => globalThis.document,
      _6312: x0 => x0.head,
      _7990: x0 => x0.value,
      _7992: x0 => x0.done,
      _8694: x0 => x0.url,
      ...
      _9087: x0 => x0.state,
      _10404: x0 => x0.coords,
      _10405: x0 => x0.timestamp,
      _10407: x0 => x0.accuracy,
      _10408: x0 => x0.latitude,
      _10409: x0 => x0.longitude,
      _10410: x0 => x0.altitude,
      _10411: x0 => x0.altitudeAccuracy,
      _10412: x0 => x0.heading,
      _10413: x0 => x0.speed,
      _10414: x0 => x0.code,
      _10415: x0 => x0.message,
      _12323: x0 => x0.name,
      _13041: () => globalThis.console,
      _13069: x0 => x0.name,
      _13070: x0 => x0.message,
      _13071: x0 => x0.code,
