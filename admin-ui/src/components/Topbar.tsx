...
const routeKeys: Record<string, string> = {
  ...
  '/customers': 'customers', '/orders': 'orders', '/settings': 'settings', '/stories': 'stories', '/news': 'news',
  ...
  return (
    <header className="sagi-topbar">
      ...
      <div className="topbar-actions">
        ...
        <button type="button" onClick={() => void api.logout()} className="btn-outline topbar-logout" aria-label={t('auth.logoutFull')}>
